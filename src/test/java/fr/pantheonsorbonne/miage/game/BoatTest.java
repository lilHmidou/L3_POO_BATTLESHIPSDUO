...
public class BoatTest {
    ...
    public void testBoatInitialization() {
        ...
        String[] boatConfig = Config.getBoatsConfig(0); // Exemple pour le premier type de bateau
        Boat boat = new Boat(cells, Integer.parseInt(boatConfig[0]), boatConfig[1], Boolean.parseBoolean(boatConfig[3]));
        ...
        assertEquals(Boolean.parseBoolean(boatConfig[3]), boat.isProtected(), "Le statut de protection du bateau doit correspondre à la configuration");
    }
    ...
    public void testBoatWithConfig() {
        String[] boatConfig = Config.getBoatsConfig(0); // Pour le premier type de bateau
        Cell[] cells = {/* créer des cellules basées sur la configuration du bateau */};
        Boat boat = new Boat(cells, Integer.parseInt(boatConfig[0]), boatConfig[1], Boolean.parseBoolean(boatConfig[3]));
